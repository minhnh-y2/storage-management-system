...
------------------------------------------------------------------------
-- THONG KE CAN CAN XUAT NHAP
CREATE VIEW V_CAN_CAN
AS
	SELECT THANG, SUM(TONGCONGXUAT) AS TONGCONGXUAT, SUM(TONGCONGNHAP) AS TONGCONGNHAP, 
	SUM(TONGCONGXUAT)-SUM(TONGCONGNHAP) AS CANCAN, NAM 
	FROM (
		SELECT THANG, TONGCONGXUAT, 0 AS TONGCONGNHAP, NAM FROM V_HANG_XUAT 
		UNION ALL 
		SELECT THANG, 0 AS TONGCONGXUAT, TONGCONGNHAP, NAM FROM V_HANG_NHAP) AS NHAP_XUAT
	GROUP BY THANG, NAM
GO
