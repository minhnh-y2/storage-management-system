...
AS
	SELECT TENHH, SUM(CTP.SOLUONG) AS SOLUONGNHAP, CTP.DONGIA, SUM(CTP.SOLUONG)*CTP.DONGIA AS TONGCONGNHAP,
...
AS
	SELECT TENHH, SUM(CTP.SOLUONG) AS SOLUONGXUAT, CTP.DONGIA, SUM(CTP.SOLUONG)*CTP.DONGIA AS TONGCONGXUAT,
		HH.MAHH, MALHH, MAKHO, MONTH(NGHOANTHANH) AS THANG, YEAR(NGHOANTHANH) AS NAM
	FROM PHIEU P
	INNER JOIN CHITIETPHIEU CTP ON CTP.MAPHIEU = P.MAPHIEU
	INNER JOIN LUUTRU LT ON CTP.MALT = LT.MALT
