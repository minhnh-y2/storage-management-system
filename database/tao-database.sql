...
--GO
CREATE PROC SP_XOACHITIETPHIEUXUAT (@MAPHIEU INT,
									@MACTP INT)
AS
	BEGIN
...
--GO
CREATE PROC SP_XOACHITIETPHIEUNHAP (@MAPHIEU INT,
									@MACTP INT)
AS
	BEGIN
		DECLARE @SOLUONG FLOAT, @MALT INT;
...
--INSERT INTO PHIEU( LOAI, TRANGTHAI, NGTHUCHIEN, NGHOANTHANH, MADT, MANV) VALUES( 1, 1, '20210610', '20210611', 2, 'khoalhd')
--SELECT * FROM PHIEU
--EXEC SP_XOACHITIETPHIEUNHAP 11, 31
--SELECT * FROM LUUTRU WHERE MAKHO = 3 AND MAHH = 'ApexPRO'
--SELECT * FROM CHITIETPHIEU WHERE MAPHIEU = 11
...
--GO
CREATE PROC SP_SUACHITIETPHIEUXUAT (@MAPHIEU INT,
									@MACTP INT,
									@SOLUONGMOI FLOAT)
AS
	BEGIN
...
--GO
CREATE PROC SP_SUACHITIETPHIEUNHAP (@MAPHIEU INT,
									@MACTP INT,
									@SOLUONGMOI FLOAT)
AS
	BEGIN
